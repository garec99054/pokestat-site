...
| --- | --- | --- |
| rf full features (all folds) | 0.332 | the reported number |
| rf STATIC features ablated (all folds) | 0.259 | 22% of the signal gone |
| rf STATIC features ablated (eval folds) | 0.282 +/- 0.017 (1 SE) | held-out, clears the 0.05 floor by more than 1 SE |
...
IC was 0.371 (IR 11.201, n_eff
5.803). The full walk-forward table below shows all models over
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pooled (headline) | 465 | 9 | 0.371 | 0.033 | 5.803 | 0.282 | 0.017 | clears 0 by > 1 SE |
| ME | 55 | 6 | 0.271 | 0.191 | 2.695 | 0.220 | 0.035 | clears 0 by > 1 SE [THIN: n_eff 2.695 < 4.0, insufficient evidence] |
| SV | 247 | 9 | 0.351 | 0.031 | 7.799 | 0.258 | 0.023 | clears 0 by > 1 SE |
| SWSH | 163 | 9 | 0.330 | 0.024 | 8.010 | 0.311 | 0.022 | clears 0 by > 1 SE |
| within-era neutralized | 465 | 9 | 0.344 | 0.019 | 9.000 | 0.277 | 0.018 | clears 0 by > 1 SE |
| between-era contrast only | 465 | 9 | 0.239 | 0.506 | 3.250 | 0.283 | 0.396 | within 1 SE of 0 |

By rarity tier the same test says: within-tier skill survives; the tier ordering on its own does not (neutralized 0.370 +/- 0.018, n_eff 9.000; contrast-only 0.207 +/- 0.458, n_eff 2.306). 4 of 6 scored tiers clear zero by more than one SE on a sufficient effective sample (n_eff >= 4.0). NOT counted as evidence, though they clear the one-SE bar: Hyper Rare (n_eff 2.000), Rare Rainbow (n_eff 3.683) -- below the 4.0 effective-fold bar this repo applies before a cell may claim a direction (the same MIN_CLAIM_N_EFF the momentum study uses), so the tier rests on roughly one independent draw and is reported as insufficient evidence rather than as corroboration. Evidence caveat (the 4.0 effective-fold bar this repo applies elsewhere before a cell may claim a direction): contrast-only does not clear the one-SE bar, but on n_eff 2.306 it could not have detected a moderate effect either -- read it as absence of evidence, not evidence of absence.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pooled (headline) | 465 | 9 | 0.371 | 0.033 | 5.803 | 0.282 | 0.017 | clears 0 by > 1 SE |
| Hyper Rare | 33 | 9 | 0.357 | 0.185 | 2.000 | 0.151 | 0.177 | clears 0 by > 1 SE [THIN: n_eff 2.000 < 4.0, insufficient evidence] |
| Mega Hyper Rare | 5 | 0 | n/a | n/a | 0.000 | n/a | n/a | skipped (never >= 8 cards in a fold) |
| Rare Rainbow | 44 | 9 | 0.340 | 0.083 | 3.683 | 0.438 | 0.054 | clears 0 by > 1 SE [THIN: n_eff 3.683 < 4.0, insufficient evidence] |
| Rare Secret | 15 | 9 | 0.274 | 0.084 | 9.000 | 0.196 | 0.091 | clears 0 by > 1 SE |
| Rare Ultra | 104 | 9 | 0.335 | 0.041 | 9.000 | 0.310 | 0.037 | clears 0 by > 1 SE |
| Special Illustration Rare | 118 | 9 | 0.440 | 0.042 | 9.000 | 0.251 | 0.030 | clears 0 by > 1 SE |
| Ultra Rare | 146 | 9 | 0.365 | 0.025 | 9.000 | 0.221 | 0.020 | clears 0 by > 1 SE |
| within-rarity neutralized | 465 | 9 | 0.370 | 0.018 | 9.000 | 0.266 | 0.016 | clears 0 by > 1 SE |
| between-rarity contrast only | 465 | 9 | 0.207 | 0.458 | 2.306 | 0.342 | 0.318 | within 1 SE of 0 |
...
This run's weakest era slice is **ME**: held-out IC 0.271
+/- 0.191 over 6 folds and 55 cards, against a
static-ablated 0.220.

**Finding: the ME cell IS a real effect.** The permutation test rejects zero (p = 0.010) and 8 of 8 candidates agree on its positive sign (roster median 0.336), so this is a property of the era rather than of the one model the selection step output. Its sign is positive, so this is the weakest slice still carrying real skill, not a defect: smaller than the other eras, not wrong.
...
| --- | --- | --- |
| permutation (20,000 draws of a random CARD-CONSTANT ranking scored through this slice's own folds) | p = 0.010 (two-sided), null SD 0.107 | separated from zero at the 0.05 level |
| bootstrap over the slice's cards (5,000 resamples) | 95% CI [0.079, 0.446] which excludes zero | sign flips in 0.3% of resamples |
| cross-candidate control (same folds, same cards, same features) | 8 of 8 candidates share the sign; median 0.336 | the roster broadly agrees |
...
tighter null than the estimator deserves. Removing the static features does not change the picture inside this slice (ablated IC 0.220 vs full 0.271).
...
| --- | --- | --- | --- | --- | --- | --- |
| before (market only) | 12 numeric + 9 ind. | rf | 0.289 | 0.338 +/- 0.102 | 3.326 | 0.232 |
| after (+ listing book) | 18 numeric + 10 ind. | rf | 0.283 | 0.371 +/- 0.033 | 11.201 | 0.282 |
...
The gain is CONCENTRATED, not spread across the six new features: adding `mid_skew` alone to the pre-spread feature set already reaches held-out 0.369, against 0.338 without it and 0.371 with all six. The other five contribute the remainder. How `mid_skew` was picked, stated so the number can be read correctly: it is the largest-magnitude univariate IC on the SELECTION folds (0.181), which are disjoint from the held-out folds every number quoted in this paragraph comes from. The pick therefore does not peek at the evaluation data, and the 0.369 is a held-out score for a pre-registered choice rather than the best of six post-hoc looks. Both columns are in the table above so the multiple-comparison context is visible either way.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ridge | 0.328 | 0.141 | 0.597 | 4.036 | 4.662 | 17.5% | 35.8% | 18.4% | 28.9% | 25.4% | 16 |
| elasticnet | 0.307 | 0.149 | 0.581 | 4.244 | 4.249 | 15.5% | 33.2% | 17.1% | 29.0% | 25.5% | 16 |
| gbm | 0.311 | 0.138 | 0.716 | 2.653 | 3.667 | 16.8% | 37.4% | 19.2% | 27.9% | 24.6% | 16 |
| ensemble | 0.349 | 0.150 | 0.688 | 2.952 | 4.004 | 18.6% | 35.7% | 18.3% | 29.5% | 25.9% | 16 |
| rank_linear | 0.330 | 0.136 | 0.542 | 4.759 | 5.308 | 17.8% | 36.4% | 18.7% | 29.6% | 26.0% | 16 |
| huber | 0.333 | 0.148 | 0.605 | 3.938 | 4.476 | 17.1% | 36.1% | 18.6% | 29.6% | 26.0% | 16 |
| pls | 0.307 | 0.150 | 0.531 | 4.896 | 4.515 | 15.9% | 32.0% | 16.4% | 30.5% | 26.8% | 16 |
| rf | 0.332 | 0.108 | 0.498 | 5.363 | 7.151 | 17.3% | 32.5% | 16.7% | 33.3% | 29.3% | 16 |
...
| reversion | 0.151 | 0.206 | 0.670 | 3.164 | 1.302 | 7.2% | 22.8% | 11.7% | 15.3% | 13.4% | 16 |
...
pooled band [-0.182, 0.197] (width 0.379) and are
marked as borrowed in the table below. Self-calibrated tier widths range from 0.267 to 0.489 (1.8x)
...
| Mega Hyper Rare | 19 | borrowed (pooled) | [-0.182, 0.197] | 0.379 | 17 | 82.4% | 80.0% |
| Rare Rainbow | 396 | own | [-0.152, 0.115] | 0.267 | 396 | 79.3% | 80.0% |
| Rare Secret | 135 | borrowed (pooled) | [-0.182, 0.197] | 0.379 | 135 | 89.6% | 80.0% |
| Rare Ultra | 936 | own | [-0.148, 0.177] | 0.326 | 936 | 82.8% | 80.0% |
| Special Illustration Rare | 883 | own | [-0.180, 0.227] | 0.407 | 883 | 85.2% | 80.0% |
| Ultra Rare | 1223 | own | [-0.240, 0.249] | 0.489 | 1223 | 80.0% | 80.0% |

Across the 5 tiers carrying their own band, realized coverage spans 79.3% to 85.2% -- a 5.9-point spread. Scored on the identical folds with ONE global band instead, the same tiers span 74.6% to 95.7% -- a 21.1-point spread; the per-tier bands are what closed the gap. Tiers still marked borrowed inherit the pooled band and are the ones left visibly off nominal -- disclosed, not fixed.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ridge | 3889 | -0.183 | 0.200 | 0.384 | 81.7% | 0.432 | 80.1% | 80.0% |
| elasticnet | 3889 | -0.182 | 0.206 | 0.387 | 81.2% | 0.433 | 80.0% | 80.0% |
| gbm | 3889 | -0.190 | 0.185 | 0.374 | 83.5% | 0.441 | 80.2% | 80.0% |
| ensemble | 3889 | -0.176 | 0.202 | 0.378 | 82.1% | 0.428 | 80.2% | 80.0% |
| rank_linear | 3889 | -0.246 | 0.271 | 0.517 | 81.4% | 0.554 | 79.9% | 80.0% |
| huber | 3889 | -0.180 | 0.203 | 0.383 | 82.3% | 0.434 | 80.1% | 80.0% |
| pls | 3889 | -0.181 | 0.205 | 0.385 | 80.9% | 0.433 | 80.0% | 80.0% |
| rf | 3889 | -0.182 | 0.197 | 0.379 | 82.1% | 0.425 | 80.3% | 80.0% |
...
Top candidate_down:
- Noivern V (Evolving Skies): predicted -0.211 (80% band [-0.359, -0.033]) [set_age +0.09; mom_3m -0.07; mid_skew -0.05]
- Rayquaza V (Evolving Skies): predicted -0.204 (80% band [-0.352, -0.026]) [log_price -0.12; premium_asof +0.12; mom_3m -0.09]
- Mega Greninja ex (Chaos Rising): predicted -0.179 (80% band [-0.362, +0.018]) [log_price -0.17; mispricing +0.13; lifecycle -0.12]

## Limitations

- Set-age/rarity effect is a LARGE part of the signal, though no longer the whole story. The "older high-rarity cards appreciate, recent cards decline" lifecycle pattern is real and sizeable: ablating the 9 static / near-time-invariant features (set_age_months, log_price, lifecycle_drift, is_sir, is_mega_hyper, is_ultra, is_rare_secret, is_rare_rainbow, is_rare_ultra) drops the all-fold mean IC from 0.332 to 0.259 (22% of it), and a univariate set_age ranking alone scores 0.309. What is new with the wider SWSH+SV+ME cross-section is that the held-out ablated-eval IC (0.282 +/- 0.017) clears the 0.05 floor by more than one SE, so a residual, non-static edge survives -- but it is a minority of the raw IC and may not persist across regimes.
- The held-out edge is within-era, not cross-era contrast (era-neutralized IC 0.344 +/- 0.019 vs era-contrast-only 0.239 +/- 0.506), but it is NOT uniform across eras. 3 of 3 scored era slices clear zero by more than one autocorrelation-aware SE. See the within-era breakdown section.
