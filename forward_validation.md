...
There is real, tradeable cross-sectional signal that survives removing the static features. The best model (rf) was chosen on 7 selection folds and scores mean rank IC 0.372 (autocorrelation-aware t-stat 11.151, n_eff 5.775) on the 9 held-out evaluation folds. Ablating the static features leaves mean IC 0.260, so the edge is not purely a set-age effect.
...
1. **Purged walk-forward CV -- confirmed already in place (no headline change).**
   ...
   status quo is retained: held-out eval mean IC is unchanged at 0.372.
...
3. **Ensemble scale bug fixed (published-number change, ensemble band only).** The
   ...
   eval IC (0.372), or any Spearman-rank number.
...
IC was 0.372 (IR 11.151, n_eff
5.775). The full walk-forward table below shows all models over
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pooled (headline) | 465 | 9 | 0.372 | 0.033 | 5.775 | 0.282 | 0.016 | clears 0 by > 1 SE |
| ME | 55 | 6 | 0.267 | 0.193 | 2.833 | 0.207 | 0.037 | clears 0 by > 1 SE [THIN: n_eff 2.833 < 4.0, insufficient evidence] |
| SV | 247 | 9 | 0.351 | 0.031 | 7.789 | 0.259 | 0.023 | clears 0 by > 1 SE |
| SWSH | 163 | 9 | 0.329 | 0.023 | 8.139 | 0.311 | 0.021 | clears 0 by > 1 SE |
...
By rarity tier the same test says: within-tier skill survives; the tier ordering on its own does not (neutralized 0.369 +/- 0.018, n_eff 9.000; contrast-only 0.201 +/- 0.462, n_eff 2.307). 4 of 6 scored tiers clear zero by more than one SE on a sufficient effective sample (n_eff >= 4.0). NOT counted as evidence, though they clear the one-SE bar: Hyper Rare (n_eff 1.937), Rare Rainbow (n_eff 3.437) -- below the 4.0 effective-fold bar this repo applies before a cell may claim a direction (the same MIN_CLAIM_N_EFF the momentum study uses), so the tier rests on roughly one independent draw and is reported as insufficient evidence rather than as corroboration. Evidence caveat (the 4.0 effective-fold bar this repo applies elsewhere before a cell may claim a direction): contrast-only does not clear the one-SE bar, but on n_eff 2.307 it could not have detected a moderate effect either -- read it as absence of evidence, not evidence of absence.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pooled (headline) | 465 | 9 | 0.372 | 0.033 | 5.775 | 0.282 | 0.016 | clears 0 by > 1 SE |
| Hyper Rare | 33 | 9 | 0.357 | 0.189 | 1.937 | 0.148 | 0.179 | clears 0 by > 1 SE [THIN: n_eff 1.937 < 4.0, insufficient evidence] |
| Mega Hyper Rare | 5 | 0 | n/a | n/a | 0.000 | n/a | n/a | skipped (never >= 8 cards in a fold) |
| Rare Rainbow | 44 | 9 | 0.338 | 0.086 | 3.437 | 0.435 | 0.057 | clears 0 by > 1 SE [THIN: n_eff 3.437 < 4.0, insufficient evidence] |
| Rare Secret | 15 | 9 | 0.269 | 0.085 | 9.000 | 0.202 | 0.090 | clears 0 by > 1 SE |
| Rare Ultra | 104 | 9 | 0.335 | 0.041 | 9.000 | 0.311 | 0.037 | clears 0 by > 1 SE |
| Special Illustration Rare | 118 | 9 | 0.440 | 0.041 | 9.000 | 0.249 | 0.029 | clears 0 by > 1 SE |
| Ultra Rare | 146 | 9 | 0.364 | 0.025 | 9.000 | 0.222 | 0.021 | clears 0 by > 1 SE |
| within-rarity neutralized | 465 | 9 | 0.369 | 0.018 | 9.000 | 0.266 | 0.015 | clears 0 by > 1 SE |
...
This run's weakest era slice is **ME**: held-out IC 0.267
+/- 0.193 over 6 folds and 55 cards, against a
static-ablated 0.207.

**Finding: the ME cell IS a real effect.** The permutation test rejects zero (p = 0.011) and 8 of 8 candidates agree on its positive sign (roster median 0.338), so this is a property of the era rather than of the one model the selection step output. Its sign is positive, so this is the weakest slice still carrying real skill, not a defect: smaller than the other eras, not wrong.
...
| bootstrap over the slice's cards (5,000 resamples) | 95% CI [0.077, 0.445] which excludes zero | sign flips in 0.3% of resamples |
| cross-candidate control (same folds, same cards, same features) | 8 of 8 candidates share the sign; median 0.338 | the roster broadly agrees |
...
tighter null than the estimator deserves. Removing the static features does not change the picture inside this slice (ablated IC 0.207 vs full 0.267).
...
| --- | --- | --- | --- | --- | --- | --- |
| before (market only) | 12 numeric + 9 ind. | rf | 0.289 | 0.338 +/- 0.103 | 3.271 | 0.232 |
| after (+ listing book) | 18 numeric + 10 ind. | rf | 0.283 | 0.372 +/- 0.033 | 11.151 | 0.282 |

Held-out mean rank IC moves 0.338 -> 0.372
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ridge | 0.327 | 0.141 | 0.596 | 4.048 | 4.662 | 17.5% | 35.8% | 18.4% | 28.7% | 25.2% | 16 |
| elasticnet | 0.307 | 0.149 | 0.581 | 4.240 | 4.240 | 15.6% | 33.5% | 17.2% | 29.0% | 25.5% | 16 |
| gbm | 0.310 | 0.148 | 0.722 | 2.581 | 3.353 | 16.7% | 37.5% | 19.3% | 28.2% | 24.8% | 16 |
| ensemble | 0.348 | 0.154 | 0.688 | 2.953 | 3.889 | 18.6% | 35.4% | 18.2% | 29.9% | 26.3% | 16 |
| rank_linear | 0.330 | 0.135 | 0.542 | 4.750 | 5.311 | 17.7% | 36.4% | 18.7% | 29.8% | 26.2% | 16 |
| huber | 0.333 | 0.148 | 0.604 | 3.955 | 4.480 | 17.2% | 36.1% | 18.6% | 29.5% | 25.9% | 16 |
| pls | 0.306 | 0.150 | 0.531 | 4.898 | 4.507 | 15.8% | 32.0% | 16.4% | 30.5% | 26.8% | 16 |
| rf | 0.333 | 0.108 | 0.496 | 5.389 | 7.163 | 17.4% | 32.8% | 16.8% | 33.3% | 29.3% | 16 |
...
| reversion | 0.150 | 0.206 | 0.670 | 3.164 | 1.297 | 7.2% | 22.5% | 11.6% | 15.3% | 13.4% | 16 |
...
pooled band [-0.183, 0.198] (width 0.380) and are
marked as borrowed in the table below. Self-calibrated tier widths range from 0.268 to 0.490 (1.8x)
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Hyper Rare | 297 | own | [-0.136, 0.184] | 0.320 | 297 | 79.5% | 80.0% |
| Mega Hyper Rare | 19 | borrowed (pooled) | [-0.183, 0.198] | 0.380 | 17 | 82.4% | 80.0% |
| Rare Rainbow | 396 | own | [-0.152, 0.116] | 0.268 | 396 | 79.3% | 80.0% |
| Rare Secret | 135 | borrowed (pooled) | [-0.183, 0.198] | 0.380 | 135 | 88.1% | 80.0% |
| Rare Ultra | 936 | own | [-0.147, 0.177] | 0.325 | 936 | 82.9% | 80.0% |
| Special Illustration Rare | 883 | own | [-0.180, 0.226] | 0.406 | 883 | 85.2% | 80.0% |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ridge | 3889 | -0.184 | 0.199 | 0.384 | 81.8% | 0.431 | 80.1% | 80.0% |
| elasticnet | 3889 | -0.182 | 0.205 | 0.387 | 81.2% | 0.433 | 80.0% | 80.0% |
| gbm | 3889 | -0.186 | 0.182 | 0.369 | 83.9% | 0.442 | 80.2% | 80.0% |
| ensemble | 3889 | -0.176 | 0.200 | 0.376 | 82.0% | 0.427 | 80.2% | 80.0% |
| rank_linear | 3889 | -0.247 | 0.271 | 0.519 | 81.5% | 0.553 | 79.9% | 80.0% |
| huber | 3889 | -0.180 | 0.203 | 0.382 | 82.4% | 0.434 | 80.1% | 80.0% |
| pls | 3889 | -0.181 | 0.204 | 0.385 | 80.9% | 0.433 | 80.0% | 80.0% |
| rf | 3889 | -0.183 | 0.198 | 0.380 | 82.1% | 0.425 | 80.3% | 80.0% |
...
Top candidate_down:
- Noivern V (Evolving Skies): predicted -0.210 (80% band [-0.357, -0.032]) [set_age +0.09; mom_3m -0.07; mid_skew -0.05]
